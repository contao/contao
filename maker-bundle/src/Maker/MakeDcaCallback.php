...
{
    public function __construct(private ContaoFramework $framework, private ClassGenerator $classGenerator, private ResourceFinder $resourceFinder, private SignatureGenerator $signatureGenerator, private ImportExtractor $importExtractor, private PhpCompatUtil $phpCompatUtil)
    {
    }
