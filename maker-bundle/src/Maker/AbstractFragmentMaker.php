...
{
    public function __construct(protected ContaoFramework $framework, protected TemplateGenerator $templateGenerator, protected ClassGenerator $classGenerator, protected DcaGenerator $dcaGenerator, protected LanguageFileGenerator $languageFileGenerator, protected PhpCompatUtil $phpCompatUtil, protected string $projectDir)
    {
    }
