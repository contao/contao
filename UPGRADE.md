...
### replaceInsertTags and insertTagFlags hooks

The `$cache` parameter (6th for `replaceInsertTags` and 7th for `insertTagFlags`) is no longer passed to the hooks,
an empty array gets passed instead.
