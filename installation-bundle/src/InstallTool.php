...
class InstallTool
{
     ...
     */
    public function __construct(private Connection $connection, private string $projectDir, private LoggerInterface $logger, private MigrationCollection $migrations)
    {
    }
