...
class ContaoCacheWarmer implements CacheWarmerInterface
{
     ...
     */
    public function __construct(private Filesystem $filesystem, private ResourceFinderInterface $finder, private FileLocator $locator, private string $projectDir, private Connection $connection, private ContaoFramework $framework, Locales $locales)
    {
     ...
     */
    private function findDcaFiles(): array|Finder
    {
        try {
     ...
     * @return Finder|array<SplFileInfo>
     */
    private function findLanguageFiles(string $language): array|Finder
    {
        try {
            return $this->finder
                ->findIn(Path::join('languages', $language))
     ...
     * @return Finder|array<SplFileInfo>
     */
    private function findTemplateFiles(): array|Finder
    {
        try {
