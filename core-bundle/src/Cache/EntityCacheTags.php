...
class EntityCacheTags
{
    ...
    public function __construct(private EntityManagerInterface $entityManager, private ?ResponseTagger $responseTagger = null, private ?CacheInvalidator $cacheInvalidator = null)
    {
    }
