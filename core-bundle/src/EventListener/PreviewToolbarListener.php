...
{
    public function __construct(private ScopeMatcher $scopeMatcher, private TokenChecker $tokenChecker, private TwigEnvironment $twig, private RouterInterface $router, private string $previewScript = '')
    {
    }
