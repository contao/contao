...
{
    public function __construct(private bool $prettyErrorScreens, private Environment $twig, private ContaoFramework $framework, private Security $security, private PageRegistry $pageRegistry, private HttpKernelInterface $httpKernel)
    {
    }
