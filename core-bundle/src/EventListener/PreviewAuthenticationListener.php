...
{
    public function __construct(private ScopeMatcher $scopeMatcher, private TokenChecker $tokenChecker, private UrlGeneratorInterface $router, private UriSigner $uriSigner, private Security $security)
    {
    }
