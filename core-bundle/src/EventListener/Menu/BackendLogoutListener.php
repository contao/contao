...
{
    public function __construct(private Security $security, private RouterInterface $router, private BaseLogoutUrlGenerator $urlGenerator, private TranslatorInterface $translator)
    {
    }
