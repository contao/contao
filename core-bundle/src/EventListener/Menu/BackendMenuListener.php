        ...
        foreach ($modules as $categoryName => $categoryData) {
            ...
            if (!$categoryNode) {
                $categoryNode = $factory
                    ...
                    ->setAttribute('data-controller', 'toggle-navigation')
                    ->setAttribute('data-toggle-navigation-collapsed-class', 'collapsed')
                    ->setAttribute('data-toggle-navigation-url-value', $path)
                    ->setAttribute('data-toggle-navigation-category-value', $categoryName)
                    ->setAttribute('data-toggle-navigation-expand-title-value', $this->translator->trans('MSC.expandNode', [], 'contao_default'))
                    ->setAttribute('data-toggle-navigation-collapse-title-value', $this->translator->trans('MSC.collapseNode', [], 'contao_default'))
                    ->setLinkAttribute('class', $this->getClassFromAttributes($categoryData))
                    ->setLinkAttribute('title', $categoryData['title'])
                    ->setLinkAttribute('data-toggle-navigation-target', 'link')
                    ->setLinkAttribute('data-action', 'toggle-navigation#toggle:prevent')
