...
{
    public function __construct(private ContaoFramework $framework, private Slug $slug, private TranslatorInterface $translator, private Connection $connection, private PageRegistry $pageRegistry, private UrlGeneratorInterface $urlGenerator, private FinalMatcherInterface $routeMatcher)
    {
    }
