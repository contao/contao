...
class ContentCompositionListener
{
    ...
    public function __construct(private ContaoFramework $framework, private Security $security, private PageRegistry $pageRegistry, private TranslatorInterface $translator, private Connection $connection, private RequestStack $requestStack)
    {
