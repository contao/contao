...
{
    public function __construct(private ContaoFilesystemLoaderWarmer $filesystemLoaderWarmer, private ThemeNamespace $themeNamespace, private TranslatorInterface $translator)
    {
    }
