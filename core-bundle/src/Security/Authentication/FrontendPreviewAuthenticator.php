...
class FrontendPreviewAuthenticator
{
     ...
     */
    public function __construct(private Security $security, private SessionInterface $session, private UserProviderInterface $userProvider, private ?LoggerInterface $logger = null)
    {
    }
