...
class AuthenticationSuccessHandler implements AuthenticationSuccessHandlerInterface
{
     ...
     */
    public function __construct(private ContaoFramework $framework, private TrustedDeviceManagerInterface $trustedDeviceManager, private FirewallMap $firewallMap, private ?LoggerInterface $logger = null)
    {
    }
