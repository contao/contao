...
class ExpiringTokenBasedRememberMeServices extends AbstractRememberMeServices
{
     ...
     */
    public function __construct(private RememberMeRepository $repository, iterable $userProviders, string $secret, string $providerKey, array $options = [], LoggerInterface $logger = null)
    {
