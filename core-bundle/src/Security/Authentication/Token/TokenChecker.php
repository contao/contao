...
class TokenChecker
{
     ...
     */
    public function __construct(private RequestStack $requestStack, private FirewallMapInterface $firewallMap, private TokenStorageInterface $tokenStorage, private SessionInterface $session, private AuthenticationTrustResolverInterface $trustResolver, private VoterInterface $roleVoter)
    {
    }
