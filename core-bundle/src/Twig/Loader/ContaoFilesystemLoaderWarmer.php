...
{
    public function __construct(private ContaoFilesystemLoader $loader, private TemplateLocator $templateLocator, private string $projectDir, private string $cacheDir, private string $environment, private ?Filesystem $filesystem = null)
    {
    }
