...
final class ContaoEscaper
{
     ...
     */
    public function escapeHtml(Environment $environment, mixed $string, string|null $charset = null): string
    {
     ...
     * @see twig_escape_filter
     */
    public function escapeHtmlAttr(Environment $environment, mixed $string, string|null $charset = null): string
    {
        if (null !== $charset && 'UTF-8' !== strtoupper($charset)) {
