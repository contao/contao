...
final class FragmentTemplate extends Template
{
     ...
     * @internal
     */
    public static function getFrontendModule($intId, $strColumn = 'main', array $arrPreloaded = []): never
    {
        self::throwOnAccess();
    }
     ...
     * @internal
     */
    public static function getArticle($varId, $blnMultiMode = false, $blnIsInsertTag = false, $strColumn = 'main', array $arrPreloaded = []): never
    {
        self::throwOnAccess();
    }
