...
final class LegacyTemplateFunctionsRuntime implements RuntimeExtensionInterface
{
    ...
    {
        trigger_deprecation('contao/core-bundle', '4.12', "Using the 'render_contao_backend_template' Twig function is deprecated and will be removed in Contao 5.0. Let your controller inherit from '%s' and your template directly from '@Contao/be_main' instead'.", AbstractCustomBackendController::class);
