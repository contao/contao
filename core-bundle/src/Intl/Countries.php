...
class Countries
{
     ...
     */
    public function __construct(private TranslatorInterface $translator, private RequestStack $requestStack, private ContaoFramework $contaoFramework, array $defaultCountries, array $configCountries, private string $defaultLocale)
    {
