...
class Dbafs implements DbafsInterface, ResetInterface
{
     ...
     */
    public function __construct(private HashGeneratorInterface $hashGenerator, private Connection $connection, private EventDispatcherInterface $eventDispatcher, private VirtualFilesystemInterface $filesystem, private string $table)
    {
    }
