...
class LightboxResult
{
     ...
     */
    public function __construct(private ContainerInterface $locator, string|ImageInterface|null $filePathOrImage, ?string $url, array|PictureConfiguration|int|string|null $sizeConfiguration = null, private ?string $groupIdentifier = null, ResizeOptions $resizeOptions = null)
    {
