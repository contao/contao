...
class FigureBuilder
{
    ...
    {
        if ($this->lastException instanceof InvalidResourceException) {
    ...
    private function onDefineMetadata(): Metadata|null
    {
        ...
        $getUuid = static function (FilesModel|null $filesModel): string|null {
            if (!$filesModel instanceof FilesModel || null === $filesModel->uuid) {
                return null;
            }
        ...
        if (!$this->filesModel instanceof FilesModel) {
            return null;
        }
