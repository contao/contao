...
class PreviewFactory
{
     ...
     */
    public function __construct(private iterable $previewProviders, private ImageFactoryInterface $imageFactory, private PictureFactoryInterface $pictureFactory, private Studio $imageStudio, private ContaoFramework $framework, private string $secret, private string $cacheDir, private array $validImageExtensions, private int $defaultSize, private int $maxSize)
    {
    }
