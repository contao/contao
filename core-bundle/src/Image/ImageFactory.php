...
class ImageFactory implements ImageFactoryInterface
{
     ...
     */
    public function __construct(private ResizerInterface $resizer, private ImagineInterface $imagine, private ImagineInterface $imagineSvg, private Filesystem $filesystem, private ContaoFramework $framework, private bool $bypassCache, private array $imagineOptions, private array $validExtensions, private string $uploadDir, private ?LoggerInterface $logger = null)
    {
    }
