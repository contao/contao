...
class ImageSizes implements ResetInterface
{
     ...
     */
    public function __construct(private Connection $connection, private EventDispatcherInterface $eventDispatcher, private ContaoFramework $framework, private TranslatorInterface $translator)
    {
    }
