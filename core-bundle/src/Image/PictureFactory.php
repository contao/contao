...
class PictureFactory implements PictureFactoryInterface
{
     ...
     */
    public function __construct(private PictureGeneratorInterface $pictureGenerator, private ImageFactoryInterface $imageFactory, private ContaoFramework $framework, private bool $bypassCache, private array $imagineOptions)
    {
    }
