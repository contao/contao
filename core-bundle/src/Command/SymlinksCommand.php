...
class SymlinksCommand extends Command
{
    ...
    public function __construct(private string $projectDir, private string $uploadPath, private string $logsDir, private ResourceFinderInterface $resourceFinder, private EventDispatcherInterface $eventDispatcher)
    {
        parent::__construct();
    }
