...
class ResizeImagesCommand extends Command
{
    ...
    public function __construct(private ImageFactoryInterface $imageFactory, ResizerInterface $resizer, private string $targetDir, private DeferredImageStorageInterface $storage, Filesystem $filesystem = null)
    {
