...
final class ContaoCoreEvents
{
    ...
    /**
     * The contao.page_type_config event is triggered when the page type config is created.
     *
     * @see PageTypeConfigEvent
     */
    public const PAGE_TYOE_CONFIG = 'contao.page_type_config';
}
