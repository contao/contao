...
[
	...
	'Chrome'     => ['browser'=>'chrome',       'shorty'=>'ch', 'engine'=>'blink',    'version'=>'/^.*Chrome\/(\d+(\.\d+)*).*$/'],
	'OmniWeb'    => ['browser'=>'omniweb',      'shorty'=>'ow', 'engine'=>'webkit',   'version'=>'/^.*Version\/(\d+(\.\d+)*).*$/'],
	'Silk'       => ['browser'=>'silk',         'shorty'=>'si', 'engine'=>'blink',    'version'=>'/^.*Silk\/(\d+(\.\d+)*).*$/'],
	...
	'Opera'      => ['browser'=>'opera',        'shorty'=>'op', 'engine'=>'blink',    'version'=>'/^.*Version\/(\d+(\.\d+)*).*$/'],
