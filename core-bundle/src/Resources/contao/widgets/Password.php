...
class Password extends Widget
{
	...
	{
		return sprintf(
			'<input type="password" autocomplete="new-password" name="%s" id="ctrl_%s" class="tl_text tl_password%s" value="%s"%s onfocus="Backend.getScrollOffset()">%s%s',
			$this->strName,
			$this->strId,
	...
	{
		return sprintf(
			'<input type="password" autocomplete="new-password" name="%s_confirm" id="ctrl_%s_confirm" class="tl_text tl_password confirm%s" value="%s"%s onfocus="Backend.getScrollOffset()">%s',
			$this->strName,
			$this->strId,
			($this->strClass ? ' ' . $this->strClass : ''),
			($this->varValue ? '*****' : ''),
