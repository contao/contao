...
(
	...
	(
		...
		'textcustom'                  => '{type_legend},type,name,label;{fconfig_legend},mandatory,rgxp,customRgxp,placeholder,errorMsg;{expert_legend:hide},class,value,minval,maxval,step,accesskey,tabindex;{template_legend:hide},customTpl;{invisible_legend:hide},invisible',
		...
		'passwordcustom'              => '{type_legend},type,name,label;{fconfig_legend},mandatory,rgxp,customRgxp,placeholder,errorMsg;{expert_legend:hide},class,value,minlength,maxlength,accesskey,tabindex;{template_legend:hide},customTpl;{invisible_legend:hide},invisible',
		...
		'textareacustom'              => '{type_legend},type,name,label;{fconfig_legend},mandatory,rgxp,customRgxp,placeholder,errorMsg;{size_legend},size;{expert_legend:hide},class,value,minlength,maxlength,accesskey,tabindex;{template_legend:hide},customTpl;{invisible_legend:hide},invisible',
