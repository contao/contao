...
(
	...
	(
		...
		'enforceTwoFactor'            => 'twofactor_jumpTo',
	),
	...
	(
		...
		'twofactor_jumpTo' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_page']['twofactor_jumpTo'],
			'exclude'                 => true,
			'inputType'               => 'pageTree',
			'foreignKey'              => 'tl_page.title',
