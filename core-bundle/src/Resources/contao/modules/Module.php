...
abstract class Module extends Frontend
{
	...
	protected function renderNavigation($pid, $level=1, $host=null, $language=null)
	{
		...
		foreach ($arrSubpages as list('page' => $objSubpage, 'hasSubpages' => $blnHasSubpages))
		{
			...
			if (!$objSubpage->protected || $this->showProtected || ($this instanceof ModuleSitemap && $objSubpage->sitemap == 'map_always') || (!$user && \is_array($groups) && \in_array(-1, $groups)) || ($user && $user->isMemberOf($groups)))
			{
