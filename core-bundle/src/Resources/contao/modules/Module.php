...
abstract class Module extends Frontend
{
	 ...
	 * @return array<array{page:PageModel,hasSubpages:bool}>|null
	 *
	 * @deprecated Deprecated since Contao 4.12, to be removed in Contao 5.0. Use Module::getPublishedSubpagesByPid() instead.
	 */
	protected static function getPublishedSubpagesWithoutGuestsByPid($intPid, $blnShowHidden=false, $blnIsSitemap=false): ?array
	{
		@trigger_error('Using PageModel::findPublishedSubpagesWithoutGuestsByPid() has been deprecated and will no longer work Contao 5.0. Use Module::getPublishedSubpagesByPid() instead.', E_USER_DEPRECATED);
