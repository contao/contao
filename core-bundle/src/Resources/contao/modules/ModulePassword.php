...
class ModulePassword extends Module
{
	...
	protected function sendPasswordLink($objMember)
	{
		...
		System::getContainer()->get('contao.monolog.system_logger')->access('A new password has been requested for user ID ' . $objMember->id . ' (' . Idna::decodeEmail($objMember->email) . ')');
