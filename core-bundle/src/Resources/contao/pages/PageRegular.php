...
class PageRegular extends Frontend
{
	...
	protected function prepare($objPage)
	{
		...
		$this->Template->pageTitle = $responseContext->getHtmlHeadManager()->getTitle();
		...
		// Meta robots tag
		$this->Template->robots = $responseContext->getHtmlHeadManager()->getMetaRobots();
		...
		$this->Template->description = str_replace(array("\n", "\r", '"'), array(' ', '', ''), $responseContext->getHtmlHeadManager()->getMetaDescription());
