 ...
 * @method static LayoutModel|null findOneByScripts($val, $opt=array())
 ...
 * @method static Model\Collection|LayoutModel[]|LayoutModel|null findByScripts($val, $opt=array())
 ...
 * @method static integer countByScripts($val, $opt=array())
