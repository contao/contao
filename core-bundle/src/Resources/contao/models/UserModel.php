 ...
 * @method static UserModel|null findOneByLoginAttempt($val, array $opt=array())
 ...
 * @method static Collection|UserModel[]|UserModel|null findByLoginAttempt($val, array $opt=array())
