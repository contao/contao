 ...
 *
 * @method static Model\Collection|FormModel[]|FormModel|null findByTstamp($val, array $opt=array())
 * @method static Model\Collection|FormModel[]|FormModel|null findByTitle($val, array $opt=array())
 * @method static Model\Collection|FormModel[]|FormModel|null findByAlias($val, array $opt=array())
 * @method static Model\Collection|FormModel[]|FormModel|null findByJumpTo($val, array $opt=array())
 * @method static Model\Collection|FormModel[]|FormModel|null findBySendViaEmail($val, array $opt=array())
 * @method static Model\Collection|FormModel[]|FormModel|null findByRecipient($val, array $opt=array())
 * @method static Model\Collection|FormModel[]|FormModel|null findBySubject($val, array $opt=array())
 * @method static Model\Collection|FormModel[]|FormModel|null findByFormat($val, array $opt=array())
 * @method static Model\Collection|FormModel[]|FormModel|null findBySkipEmpty($val, array $opt=array())
 * @method static Model\Collection|FormModel[]|FormModel|null findByStoreValues($val, array $opt=array())
 * @method static Model\Collection|FormModel[]|FormModel|null findByTargetTable($val, array $opt=array())
 * @method static Model\Collection|FormModel[]|FormModel|null findByMethod($val, array $opt=array())
 * @method static Model\Collection|FormModel[]|FormModel|null findByNovalidate($val, array $opt=array())
 * @method static Model\Collection|FormModel[]|FormModel|null findByAttributes($val, array $opt=array())
 * @method static Model\Collection|FormModel[]|FormModel|null findByFormID($val, array $opt=array())
 * @method static Model\Collection|FormModel[]|FormModel|null findByTableless($val, array $opt=array())
 * @method static Model\Collection|FormModel[]|FormModel|null findByAllowTags($val, array $opt=array())
 * @method static Model\Collection|FormModel[]|FormModel|null findMultipleByIds($val, array $opt=array())
 * @method static Model\Collection|FormModel[]|FormModel|null findBy($col, $val, array $opt=array())
 * @method static Model\Collection|FormModel[]|FormModel|null findAll(array $opt=array())
 *
