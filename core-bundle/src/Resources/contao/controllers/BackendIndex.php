...
class BackendIndex extends Backend
{
	...
	public function run()
	{
		...
		$objTemplate->languages = System::getContainer()->get(Locales::class)->getDisplayNames(System::getContainer()->getParameter('contao.locales'), null, true); // backwards compatibility
