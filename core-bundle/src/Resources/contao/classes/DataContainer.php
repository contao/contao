...
abstract class DataContainer extends Backend
{
	...
	protected function row($strPalette=null)
	{
		...
		if (Input::post('FORM_SUBMIT') == $this->strTable)
		{
			...
			{
				trigger_deprecation('contao/core-bundle', '4.2', 'Using FORM_FIELDS has been deprecated and will no longer work in Contao 5.0. Make sure to always submit at least an empty string in your widget.');
			}
