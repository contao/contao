...
class FragmentHandler extends BaseFragmentHandler
{
     ...
     */
    public function __construct(ContainerInterface $renderers, private BaseFragmentHandler $fragmentHandler, RequestStack $requestStack, private FragmentRegistryInterface $fragmentRegistry, private ContainerInterface $preHandlers, bool $debug = false)
    {
