...
class ImagesController
{
    ...
    public function __construct(private ImageFactoryInterface $imageFactory, private ResizerInterface $resizer, private string $targetDir, Filesystem $filesystem = null)
    {
