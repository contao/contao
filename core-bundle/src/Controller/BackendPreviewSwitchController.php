...
{
    public function __construct(private FrontendPreviewAuthenticator $previewAuthenticator, private TokenChecker $tokenChecker, private Connection $connection, private Security $security, private TwigEnvironment $twig, private RouterInterface $router, private ContaoCsrfTokenManager $tokenManager, private array $backendAttributes = [], private string $backendBadgeTitle = '')
    {
    }
