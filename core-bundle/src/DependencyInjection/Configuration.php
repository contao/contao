...
class Configuration implements ConfigurationInterface
{
    ...
    private function addThemeNode(): NodeDefinition
    {
        return (new TreeBuilder('theme'))
            ->getRootNode()
            ->addDefaultsIfNotSet()
            ->children()
                ->arrayNode('brand')
                    ...
                    ->children()
                        ->scalarNode('color')
                            ->info('Configures the brand color.')
                            ->defaultValue('')
                        ->end()
                        ->booleanNode('whitelabel')
                            ->info('Hides the contao logo in the header and on the login form.')
                            ->defaultValue(false)
                        ->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('environment')
                    ...
                    ->children()
                        ->scalarNode('title')
                            ->info('Specifies the title of the environment.')
                            ->defaultValue('')
                        ->end()
                        ->scalarNode('background_color')
                            ->info('Configures the background color of the environment.')
                            ->defaultValue('')
                        ->end()
                        ->scalarNode('text_color')
                            ->info('Configures the text color of the environment.')
                            ->defaultValue('')
                        ->end()
                    ->end()
                ->end()
                ->arrayNode('main')
                    ...
                    ->children()
                        ->scalarNode('background_color')
                            ->info('Configures the background color of the main.')
                            ->defaultValue('')
                        ->end()
                    ->end()
                ->end()
