    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $treeBuilder
            ...
            ->children()
                ...
                ->end()
                ->scalarNode('web_dir')
                    ->info('Absolute path to the web directory. Make sure to prefix a custom path with %kernel.project_dir%.')
        ...
        return (new TreeBuilder('image'))
            ...
            ->children()
                ...
                ->booleanNode('reject_large_uploads')
                    ->info('Allows to reject uploaded images exceeding the localconfig.gdMaxImgWidth and localconfig.gdMaxImgHeight dimensions.')
                    ->defaultValue(false)
                ->end()
                ->arrayNode('sizes')
