        ...
        return (new TreeBuilder('crawl'))
            ...
            ->children()
                ->integerNode('concurrency')
                    ->info('The number of concurrent requests that are executed in the back end. Defaults to 5.')
                    ->min(1)
                    ->defaultValue(5)
                ->end()
                ->integerNode('max_depth')
                    ->info('The maximum depth to crawl in the back end. Defaults to 10.')
                    ->min(0)
                    ->defaultValue(10)
                ->end()
                ->integerNode('max_requests')
                    ->info('The maximum number of requests to execute in the back end. Defaults to 20.')
                    ->min(0)
                    ->defaultValue(20)
                ->end()
