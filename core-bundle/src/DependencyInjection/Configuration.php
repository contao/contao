    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $treeBuilder
            ...
            ->children()
                ...
                ->end()
                ->scalarNode('downloadable_files')
                    ->defaultValue('jpg,jpeg,gif,png,svg,svgz,webp,avif,heic,jxl,odt,ods,odp,odg,ott,ots,otp,otg,pdf,doc,docx,dot,dotx,xls,xlsx,xlt,xltx,ppt,pptx,pot,potx,mp3,mp4,m4a,m4v,webm,ogg,ogv,wma,wmv,ram,rm,mov,zip,rar,7z,md')
                ->end()
                ->scalarNode('web_dir')
