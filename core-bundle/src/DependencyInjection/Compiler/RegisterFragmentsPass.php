...
class RegisterFragmentsPass implements CompilerPassInterface
{
    ...
    {
        if (null === $tag) {
            trigger_deprecation('contao/core-bundle', '4.9', 'Using "new RegisterFragmentsPass()" without passing the tag name has been deprecated and will no longer work in Contao 5.0.');
        }
