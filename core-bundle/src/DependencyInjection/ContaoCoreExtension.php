...
class ContaoCoreExtension extends Extension implements PrependExtensionInterface, ConfigureFilesystemInterface
{
    ...
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        $container->setParameter('contao.altcha.algorithm', $config['altcha']['algorithm']);
        $container->setParameter('contao.altcha.range_min', $config['altcha']['range_min']);
        $container->setParameter('contao.altcha.range_max', $config['altcha']['range_max']);
        $container->setParameter('contao.altcha.challenge_expiry', $config['altcha']['challenge_expiry']);
