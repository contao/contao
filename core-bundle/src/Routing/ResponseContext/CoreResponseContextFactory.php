...
{
    public function __construct(private ResponseContextAccessor $responseContextAccessor, private EventDispatcherInterface $eventDispatcher, private TokenChecker $tokenChecker, private HtmlDecoder $htmlDecoder, private RequestStack $requestStack, private InsertTagParser $insertTagParser)
    {
    }
