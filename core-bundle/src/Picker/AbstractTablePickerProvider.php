...
abstract class AbstractTablePickerProvider implements PickerProviderInterface, DcaPickerProviderInterface, PickerMenuInterface
{
    ...
    public function __construct(private ContaoFramework $framework, private FactoryInterface $menuFactory, private RouterInterface $router, private TranslatorInterface $translator, private Connection $connection)
    {
    }
