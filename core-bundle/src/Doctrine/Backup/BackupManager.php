...
class BackupManager
{
    ...
    public function __construct(private Connection $connection, private DumperInterface $dumper, private VirtualFilesystemInterface $backupsStorage, private array $tablesToIgnore, private RetentionPolicyInterface $retentionPolicy)
    {
    }
