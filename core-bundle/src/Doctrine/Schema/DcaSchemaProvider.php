            ...
            if (isset($definitions['SCHEMA_FIELDS'])) {
                foreach ($definitions['SCHEMA_FIELDS'] as $fieldName => $conf) {
                    ...
                    if (isset($options['customSchemaOptions'])) {
                        trigger_deprecation('contao/core-bundle', '5.6', 'Using the "customSchemaOptions" option is deprecated and will no longer work in Contao 6. Use the "platformOptions" option instead.');
