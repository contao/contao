 ...
 *
 * @method static Collection<ModuleModel>|null findByPid($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByTstamp($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByName($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByHeadline($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByType($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByAriaLabel($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByLevelOffset($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByShowLevel($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByHardLimit($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByShowProtected($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByDefineRoot($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByRootPage($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByNavigationTpl($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByCustomTpl($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByPages($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByShowHidden($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByCustomLabel($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByAutologin($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByJumpTo($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByPwResetPage($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByOverviewPage($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByRedirectBack($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByEditable($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByReqFullAuth($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByMemberTpl($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByTableless($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByForm($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByQueryType($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByFuzzy($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByContextLength($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByMinKeywordLength($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByPerPage($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findBySearchType($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findBySearchTpl($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByInColumn($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findBySkipFirst($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByLoadFirst($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findBySingleSRC($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByUrl($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByImgSize($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByUseCaption($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByFullsize($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByMultiSRC($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByHtml($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByUnfilteredHtml($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByRss_cache($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByRss_feed($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByRss_template($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByNumberOfItems($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByDisableCaptcha($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByReg_groups($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByReg_allowLogin($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByReg_skipName($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByReg_close($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByReg_deleteDir($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByReg_assignDir($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findByReg_homeDir($val, array $opt=array())
 ...
 * @method static Collection<ModuleModel>|null findByCssID($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findBySpace($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findMultipleByIds($val, array $opt=array())
 * @method static Collection<ModuleModel>|null findBy($col, $val, array $opt=array())
 * @method static Collection<ModuleModel>|null findAll(array $opt=array())
 *
