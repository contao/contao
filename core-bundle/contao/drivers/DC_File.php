...
<div data-controller="contao--jump-targets" data-contao--jump-targets-prev-label-value="' . $GLOBALS['TL_LANG']['MSC']['scrollLeft'] . '" data-contao--jump-targets-next-label-value="' . $GLOBALS['TL_LANG']['MSC']['scrollRight'] . '">
	<div class="jump-targets" data-controller="contao--sticky-observer"><div class="inner" data-contao--jump-targets-target="navigation" data-action="scroll->contao--jump-targets#updateScrollButtonVisibility resize@window->contao--jump-targets#updateScrollButtonVisibility"></div></div>
	' . $return . '
</div>';
