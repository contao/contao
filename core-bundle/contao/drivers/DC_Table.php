  ...
  ' . $strButtons . '
	...
	protected function searchMenu()
	{
		...
		foreach ($searchFields as $field)
		{
			...
			$options_sorter[$option_label . '_' . $field] = '  <option value="' . StringUtil::specialchars($field) . '"' . (((isset($session['search'][$this->strTable]['field']) && $session['search'][$this->strTable]['field'] == $field) || (!isset($session['search'][$this->strTable]['field']) && ($GLOBALS['TL_DCA'][$this->strTable]['list']['sorting']['defaultSearchField'] ?? null) == $field)) ? ' selected="selected"' : '') . '>' . $option_label . '</option>';
		}
