...
(
	...
	'palettes' => array
	(
		'__selector__'                => array('type', 'addImage', 'sortable', 'useImage', 'overwriteMeta', 'overwriteLink', 'protected', 'splashImage', 'markdownSource', 'inline', 'showPreview'),
	...
	(
		...
		(
			...
			'inputType'               => 'text',
			'eval'                    => array('rgxp'=>'natural', 'tl_class'=>'w25'),
			'sql'                     => array('type'=>'integer', 'unsigned'=>true, 'default'=>300)
		),
...
class tl_content extends Backend
{
	...
	{
		return ' <a href="' . StringUtil::ampersand($this->addToUrl('key=list')) . '" data-action="contao--scroll-offset#store">' . Image::getHtml('tablewizard.svg', $GLOBALS['TL_LANG']['MSC']['lw_import'][1]) . '</a>';
	}
