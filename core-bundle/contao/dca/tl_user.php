...
<div class="widget">
  <fieldset class="tl_checkbox_container" data-controller="contao--check-all">
    ...
    <span><input type="checkbox" id="check_all_purge" class="tl_checkbox" data-contao--check-all-target="checkAll" data-action="contao--check-all#toggleAll"> <label for="check_all_purge" class="check-all"><em>' . $GLOBALS['TL_LANG']['MSC']['selectAll'] . '</em></label></span>
    ' . implode("\n", $options) . '
  </fieldset>' . $dc->help() . '
</div>';
	}
