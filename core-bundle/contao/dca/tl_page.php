...
(
	...
	(
		...
		'regular'                     => '{title_legend},title,type;{routing_legend},alias,requireItem,routePath,routePriority,routeConflicts;{meta_legend},pageTitle,robots,description,serpPreview,primaryImage;{canonical_legend:hide},canonicalLink,canonicalKeepParams;{protected_legend:hide},protected;{layout_legend:hide},includeLayout;{cache_legend:hide},includeCache;{chmod_legend:hide},includeChmod;{expert_legend:hide},cssClass,sitemap,searchIndexer,hide,guests;{tabnav_legend:hide},accesskey;{publish_legend},published,start,stop',
	...
	(
		...
		(
			...
			'sql'                     => array('type'=>'string', 'length'=>64, 'default'=>'regular')
		),
		'alias' => array
		(
			'search'                  => true,
		...
		(
			...
			'sql'                     => array('type'=>'string', 'length'=>32, 'default'=>'permanent')
		),
		'alwaysForward' => array
		(
			'exclude'                 => true,
		...
		'primaryImage' => array(
			'inputType'               => 'fileTree',
			'eval'                    => array('multiple' => false, 'fieldType' => 'radio', 'filesOnly' => true, 'extensions' => '%contao.image.valid_extensions%', 'mandatory' => false, 'tl_class' => 'clr'),
