...
<div class="w50 widget">
  ...
  <select name="original" id="ctrl_original" class="tl_select" data-controller="contao--select" data-action="focus->contao--scroll-offset#store">' . $strAllTemplates . '</select>' . (($GLOBALS['TL_LANG']['tl_templates']['original'][1] && Config::get('showHelp')) ? '
