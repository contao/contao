...
abstract class Controller extends System
{
	 ...
	 * @param array  $arrPreloaded
	 *
	 * @return string The module HTML markup
	 */
	public static function getFrontendModule($intId, $strColumn='main', array $arrPreloaded=array())
	{
		...
		if (!\is_object($intId) && $intId == 0)
		{
			...
			{
				$return .= static::getArticle($objArticles->current(), $blnMultiMode, false, $strColumn, $arrPreloaded[$strColumn] ?? array());
			}
	 ...
	 */
	public static function getArticle($varId, $blnMultiMode=false, $blnIsInsertTag=false, $strColumn='main', array $arrPreloaded=array())
	{
		global $objPage;
		...
		$objArticle->setPreloadedModules($arrPreloaded);
