...
class Form extends Hybrid
{
	...
	protected function processFormData($arrSubmitted, $arrLabels, $arrFields, $arrFiles)
	{
		...
		if ($this->objModel->confirmationMessage)
		{
			...
			$confirmationMessage = System::getContainer()->get('contao.string.simple_token_parser')->parse($confirmationMessage, array_map(array(StringUtil::class, 'specialchars'), $arrSubmitted));
