...
class CheckBoxWizard extends Widget
{
	...
	{
		trigger_deprecation('contao/core-bundle', '5.6', 'Using "%s()" has been deprecated and will no longer work in Contao 6. Use the checkbox_wizard.html.twig template instead.', __METHOD__);
