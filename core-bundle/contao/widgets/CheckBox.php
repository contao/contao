...
class CheckBox extends Widget
{
	...
	protected function generateCheckbox($arrOption, $i)
	{
		return \sprintf(
			...
			$this->getAttributes(),
			$this->multiple ? ' data-contao--checkbox-target="input" data-contao--check-all-target="input"' : '',
			$this->strId . '_' . $i,
