...
class ModelTest extends TestCase
{
    ...
    public function testThrowsExceptionForNonExistantRelations()
    {
     ...
     */
    public function testIncludesTableAndRelationNameForNonExistantRelationsInException(string $table, string $relation)
    {
