...
class ContentElementTestCase extends TestCase
{
     ...
     */
    protected function renderWithModelData(AbstractContentElementController $controller, array $modelData, string|null $template = null, bool $asSummary = false, array &$responseContextData = null): Response
    {
