...
use Contao\CoreBundle\Controller\Page\Error503PageController;
use Contao\CoreBundle\Tests\TestCase;
use Contao\FrontendIndex;
use Contao\PageModel;
use Symfony\Component\HttpFoundation\Response;

class Error503PageControllerTest extends TestCase
{
    public function testRendersThePageThroughFrontendIndex(): void
    {
        ...
        $controller = new Error503PageController($framework);
