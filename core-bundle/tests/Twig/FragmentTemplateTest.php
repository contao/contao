...
class FragmentTemplateTest extends TestCase
{
    ...
    {
        $excluded = ['__construct', '__set', '__get', '__isset', 'setData', 'getData', 'setName', 'getName', 'getResponse', 'addCspSource', 'addCspHash', 'inlineStyle', 'extractStyleAttributesForCsp', 'nonce', 'attr'];
