...
class AddNodeTest extends TestCase
{
    public function testCompilesAddNode(): void
    {
        $addNode = new AddNode(
            ...
            ['identifier' => 'identifier', 'location' => DocumentLocation::endOfBody],
            1,
        );
        ...
        $expectedSource = <<<'SOURCE'
            ...
            $this->env->getRuntime("Contao\\CoreBundle\\Twig\\Runtime\\HtmlDocumentRuntime")->add(
                $__contao_document_content, \Contao\CoreBundle\Twig\ResponseContext\DocumentLocation::endOfBody, "identifier"
            );
