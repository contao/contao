...
class DefaultDataContainerVoterTest extends TestCase
{
    public function testVoter(): void
    {
        ...
        $this->assertSame(
            ...
            $voter->vote($this->createStub(TokenInterface::class), 'foobar', ['foobar']),
        );

        $this->assertSame(
            VoterInterface::ACCESS_GRANTED,
            $voter->vote($this->createStub(TokenInterface::class), 'foobar', [ContaoCorePermissions::DC_PREFIX.'foobar']),
        );
    }
}
