...
class TablePickerProviderTest extends ContaoTestCase
{
     ...
     * @group legacy
     *
     * @expectedDeprecation The usage of a non fully qualified class name "Table" for table "tl_foobar" as DataContainer name has been deprecated and will no longer work in Contao 5.0. Use the fully qualified class name instead, e.g. Contao\DC_Table::class.
     */
     ...
     * @group legacy
     *
     * @expectedDeprecation The usage of a non fully qualified class name "Foobar" for table "tl_foobar" as DataContainer name has been deprecated and will no longer work in Contao 5.0. Use the fully qualified class name instead, e.g. Contao\DC_Table::class.
     */
