...
{
    public function __construct(private Security $security, private RouterInterface $router, private RequestStack $requestStack, private TranslatorInterface $translator, private bool $debug, private ?string $managerPath, private ?JwtManager $jwtManager)
    {
    }
