...
class BackendMenuListenerTest extends ContaoTestCase
{
    ...
    public function testAddsTheHoverClassIfTheDebugModeIsEnabled(): void
    {
        ...
        $listener = new BackendMenuListener($security, $router, $requestStack, true, null, $jwtManager);
        $listener($event);
    ...
    public function testAddsTheManagerLink(): void
    {
        ...
        $listener = new BackendMenuListener($security, $router, $requestStack, false, $managerPath, null);
        $listener($event);
