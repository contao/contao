...
' . $arrRow['comment'] . '
	...
	public function toggleIcon($row, $href, $label, $title, $icon, $attributes)
	{
		...
		$titleDisabled = isset($GLOBALS['TL_DCA']['tl_comments']['list']['operations']['toggle']['label'][2]) ? sprintf($GLOBALS['TL_DCA']['tl_comments']['list']['operations']['toggle']['label'][2], $row['id']) : $title;
